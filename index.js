...
//Code Here
for (let i = 0; i < nums.length; i++) {if(nums[i]%2==0){
...
if (myFavoriteNumbers.length < 7){
  console.log("There are not 7 elements.")
...
for (let i = 0; i < listOfNumbers.length; i++) {if(listOfNumbers[i]%3==0){
  console.log(listOfNumbers[i].toString()+ " is divisible by three")
